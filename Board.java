...
public class Board {
    ...
    public State stepGame(Seed player, int selectedRow, int selectedCol) {
        ...
        if (cells[selectedRow][0].content == player  // 4-in-the-row
                && cells[selectedRow][1].content == player
                && cells[selectedRow][2].content == player
                && cells[selectedRow][3].content == player
                || cells[0][selectedCol].content == player // 4-in-the-column
                && cells[1][selectedCol].content == player
                && cells[2][selectedCol].content == player
                && cells[3][selectedCol].content == player
                || selectedRow == selectedCol     // 4-in-the-diagonal
                && cells[0][0].content == player
                && cells[1][1].content == player
                && cells[2][2].content == player
                && cells[3][3].content == player
                || selectedRow + selectedCol == 2 // 4-in-the-opposite-diagonal
                && cells[0][3].content == player
                && cells[1][2].content == player
                && cells[2][1].content == player
